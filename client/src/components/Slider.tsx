          ...
          >
            <SwiperSlide className="h-screen flex flex-col w-full  justify-center items-center bg-blue-gradient">
              <div className=" w-full flex flex-col justify-center items-center">
               ...
               <p className={`${index === 2 ? 'hidden' : ''} text-white text-xl mt-10`}>
                ...
                <button
                  ...
                  type="button"
                  className={`${index === 2 ? '' : 'hidden'} mt-10 text-white w-[50%] md:w-[20%] mt-2 border-[1px] p-2 border-white hover:bg-[#3d4f7c] rounded-full cursor-pointer`}
                >
                 Continue
